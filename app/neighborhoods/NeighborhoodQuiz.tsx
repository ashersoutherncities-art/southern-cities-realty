...
const QUIZ: Q[] = [
  {
    ...
    layout: 'photo',
    a: [
      { t: 'Buzzing & walkable', sub: 'Patios, nightlife, energy', img: '/neighborhoods/south-end.jpg', s: ['plaza-midwood', 'noda', 'uptown', 'south-end', 'midtown', 'camp-north-end', 'loso', 'dilworth', 'elizabeth'] },
      { t: 'Calm & green', sub: 'Space to breathe', img: '/neighborhoods/weddington.jpg', s: ['ballantyne', 'matthews', 'myers-park', 'weddington', 'stonehaven', 'cotswold', 'mint-hill', 'coulwood', 'huntersville'] },
      { t: 'Historic & charming', sub: 'Tree-lined, front porches', img: '/neighborhoods/dilworth.jpg', s: ['dilworth', 'elizabeth', 'davidson', 'myers-park', 'wesley-heights', 'biddleville', 'belmont', 'plaza-midwood'] },
      { t: 'Lake & open water', sub: 'Boats and big skies', img: '/neighborhoods/cornelius.jpg', s: ['cornelius', 'davidson', 'mooresville', 'steele-creek', 'gastonia'] },
    ],
  },
  {
    q: 'Your ideal lot?',
    layout: 'list',
    a: [
      { t: 'Low-maintenance — lock up and go', icon: '✨', s: ['uptown', 'south-end', 'noda', 'loso', 'southpark', 'midtown', 'camp-north-end'] },
      { t: 'A classic yard in a real neighborhood', icon: '🏡', s: ['dilworth', 'matthews', 'cotswold', 'myers-park', 'huntersville', 'elizabeth', 'plaza-midwood', 'stonehaven', 'eastland', 'enderly-park', 'university', 'pineville', 'kannapolis', 'belmont', 'gastonia', 'wesley-heights', 'biddleville'] },
      { t: 'Space and acreage, room between homes', icon: '🌳', s: ['weddington', 'marvin', 'waxhaw', 'mint-hill', 'harrisburg', 'coulwood', 'indian-trail'] },
    ],
  },
  {
    ...
    layout: 'photo',
    a: [
      { t: 'Live music, art & food', img: '/neighborhoods/quiz/wknd-music.jpg', s: ['noda', 'plaza-midwood', 'south-end', 'camp-north-end', 'midtown', 'elizabeth'] },
      { t: 'On the water or outdoors', img: '/neighborhoods/quiz/wknd-water.jpg', s: ['cornelius', 'davidson', 'mooresville', 'steele-creek', 'coulwood', 'gastonia'] },
      { t: 'Shopping & dining out', img: '/neighborhoods/quiz/wknd-shopping.jpg', s: ['southpark', 'uptown', 'cotswold', 'pineville', 'ballantyne', 'university', 'midtown'] },
      { t: 'Strolling historic streets', img: '/neighborhoods/quiz/wknd-historic.jpg', s: ['dilworth', 'myers-park', 'elizabeth', 'davidson', 'wesley-heights', 'biddleville', 'belmont', 'matthews', 'kannapolis', 'waxhaw'] },
    ],
  },
  {
    ...
    layout: 'list',
    a: [
      { t: 'Walk to coffee, work and nightlife', icon: '☕', s: ['south-end', 'uptown', 'plaza-midwood', 'noda', 'dilworth', 'midtown', 'camp-north-end', 'loso', 'elizabeth'] },
      { t: 'Peace, quiet and privacy', icon: '🌿', s: ['weddington', 'mint-hill', 'harrisburg', 'indian-trail', 'waxhaw', 'marvin', 'coulwood', 'stonehaven', 'eastland', 'enderly-park'] },
      { t: 'Shopping, dining and convenience', icon: '🛍️', s: ['southpark', 'cotswold', 'pineville', 'ballantyne', 'university', 'uptown'] },
      { t: 'A walkable, small-town center', icon: '🏘️', s: ['davidson', 'matthews', 'waxhaw', 'huntersville', 'belmont', 'kannapolis', 'mooresville', 'cornelius'] },
    ],
  },
  {
    ...
    layout: 'list',
    a: [
      { t: 'Walking distance or a quick hop', icon: '🚶', s: ['uptown', 'dilworth', 'plaza-midwood', 'noda', 'south-end', 'elizabeth', 'midtown', 'camp-north-end', 'loso', 'wesley-heights', 'biddleville'] },
      { t: 'A short, easy drive', icon: '🚗', s: ['southpark', 'ballantyne', 'matthews', 'cotswold', 'pineville', 'university', 'stonehaven', 'mint-hill', 'steele-creek', 'eastland', 'enderly-park', 'coulwood'] },
      { t: 'Happy to drive for the right home', icon: '🛣️', s: ['cornelius', 'davidson', 'waxhaw', 'weddington', 'indian-trail', 'concord', 'kannapolis', 'harrisburg', 'marvin', 'mooresville', 'huntersville', 'gastonia', 'belmont'] },
    ],
  },
  {
    ...
    layout: 'photo',
    a: [
      { t: 'Historic charm & character', img: '/neighborhoods/quiz/home-historic.jpg', s: ['dilworth', 'myers-park', 'plaza-midwood', 'elizabeth', 'davidson', 'wesley-heights', 'biddleville', 'belmont'] },
      { t: 'New & modern', img: '/neighborhoods/quiz/home-modern.jpg', s: ['ballantyne', 'university', 'indian-trail', 'harrisburg', 'midtown', 'concord'] },
      { t: 'Upscale & polished', img: '/neighborhoods/quiz/home-upscale.jpg', s: ['southpark', 'myers-park', 'weddington', 'marvin', 'ballantyne', 'cotswold'] },
      { t: 'Eclectic & one-of-a-kind', img: '/neighborhoods/quiz/home-eclectic.jpg', s: ['noda', 'plaza-midwood', 'loso', 'camp-north-end'] },
    ],
  },
  {
    ...
    layout: 'list',
    a: [
      { t: 'I work from home most days', icon: '💻', s: ['davidson', 'waxhaw', 'weddington', 'mooresville', 'matthews', 'kannapolis', 'gastonia', 'coulwood', 'mint-hill', 'harrisburg'] },
      { t: 'A quick trip into Uptown', icon: '🚊', s: ['south-end', 'dilworth', 'noda', 'plaza-midwood', 'elizabeth', 'midtown', 'camp-north-end', 'loso', 'uptown', 'wesley-heights'] },
      { t: 'Out to the office parks and suburbs', icon: '🏢', s: ['ballantyne', 'university', 'concord', 'harrisburg', 'huntersville', 'steele-creek', 'pineville', 'stonehaven', 'eastland'] },
    ],
  },
  {
    ...
    layout: 'list',
    a: [
      { t: 'Greenways, trails and parks', icon: '🌳', s: ['davidson', 'matthews', 'huntersville', 'mint-hill', 'ballantyne', 'dilworth', 'midtown', 'myers-park', 'gastonia'] },
      { t: 'A big backyard and a porch', icon: '🏡', s: ['weddington', 'marvin', 'waxhaw', 'harrisburg', 'indian-trail', 'coulwood', 'stonehaven', 'eastland', 'enderly-park'] },
      { t: 'Sidewalk cafes and city parks', icon: '🏙️', s: ['uptown', 'south-end', 'plaza-midwood', 'noda', 'elizabeth', 'midtown', 'camp-north-end', 'loso'] },
      { t: 'Golf, clubs and open space', icon: '⛳', s: ['ballantyne', 'weddington', 'marvin', 'cotswold', 'pineville', 'concord'] },
    ],
  },
]

...
export const NEIGHBORHOODS: Neighborhood[] = [
  ...
  {
    slug: 'camp-north-end', name: 'Camp North End', subtitle: 'Charlotte', group: 'Charlotte Neighborhoods',
    image: null,
    about: "A 76-acre creative district in a reimagined century-old industrial campus just north of Uptown. Restored warehouses now hold restaurants, breweries, studios, and offices, wrapped in large-scale murals, with a steady calendar of markets, festivals, and events.",
    food: 'Chef-driven restaurants (Leah & Louise among them), rotating food and drink vendors, breweries, and rooftop bars.',
    shops: 'Independent makers, design studios, and pop-up retail across the campus.',
    thingsToDo: 'Murals and public art, outdoor markets, live music, and festivals year-round, with NoDa and Uptown just minutes away.',
    nearby: ['noda', 'uptown', 'plaza-midwood'],
  },
  {
    slug: 'wesley-heights', name: 'Wesley Heights', subtitle: 'West Charlotte', group: 'Charlotte Neighborhoods',
    image: null,
    about: "A historic streetcar suburb just west of Uptown, known for its restored early-1900s bungalows and craftsman homes, brick-lined streets, and greenway access. One of Charlotte's fastest-changing near-Uptown neighborhoods, minutes from the stadium and center city.",
    food: 'A growing mix of neighborhood restaurants and breweries, with Camp North End and Uptown dining just minutes away.',
    shops: 'Local storefronts and everyday essentials nearby, plus the full range of Uptown a short drive east.',
    thingsToDo: 'Walk the Stewart Creek Greenway, catch a Panthers game at Bank of America Stadium, and take in the historic architecture.',
    nearby: ['uptown', 'camp-north-end', 'biddleville'],
  },
  {
    slug: 'enderly-park', name: 'Enderly Park', subtitle: 'West Charlotte', group: 'Charlotte Neighborhoods',
    image: null,
    about: "A close-knit west Charlotte neighborhood a couple of miles from Uptown along the Tuckaseegee Road corridor. Modest early-20th-century homes, a strong community identity, and a wave of new investment and revitalization.",
    food: 'Longtime local eateries along Tuckaseegee and Freedom, with more options a short drive toward Uptown and the west side.',
    shops: 'Neighborhood markets and everyday retail nearby.',
    thingsToDo: 'Stewart Creek Greenway access, community parks, and quick routes into Uptown.',
    nearby: ['wesley-heights', 'biddleville', 'uptown'],
  },
  {
    slug: 'biddleville', name: 'Biddleville & Biddle Heights', subtitle: 'West Charlotte', group: 'Charlotte Neighborhoods',
    image: null,
    about: "One of Charlotte's oldest historically African American neighborhoods, anchored by Johnson C. Smith University along the Beatties Ford Road corridor just northwest of Uptown. Historic homes, deep community roots, and growing renewal.",
    food: 'Local soul food and neighborhood spots along Beatties Ford Road, with Uptown dining minutes away.',
    shops: 'Neighborhood storefronts and everyday needs along Beatties Ford Road.',
    thingsToDo: 'Johnson C. Smith University events, the historic Five Points area, and the CityLYNX Gold Line streetcar into Uptown.',
    nearby: ['wesley-heights', 'enderly-park', 'uptown'],
  },
  {
    slug: 'coulwood', name: 'Coulwood', subtitle: 'Northwest Charlotte', group: 'North Charlotte',
    image: null,
    about: "A quiet, established residential area in far northwest Charlotte near Mountain Island Lake and the Catawba River. Larger lots, mature trees, and a relaxed, suburban feel with easy access to I-85 and Mount Holly.",
    food: 'Everyday dining along Brookshire Boulevard and toward Mount Holly.',
    shops: 'Neighborhood retail along Brookshire Boulevard.',
    thingsToDo: 'Boating and paddling on Mountain Island Lake, plus nearby greenways and nature areas.',
    nearby: ['huntersville', 'university', 'uptown'],
  },
  {
    slug: 'eastland', name: 'Eastland', subtitle: 'East Charlotte', group: 'South & East Charlotte',
    image: null,
    about: "An East Charlotte area along the Central Avenue corridor, best known for the former Eastland Mall site — now the Eastland Yards redevelopment bringing new housing, recreation, and community space. One of the city's most diverse, international pockets, with attainable homes and quick Uptown access.",
    food: "One of Charlotte's most diverse dining corridors — international restaurants and markets along Central Avenue and Albemarle Road.",
    shops: 'International grocers and everyday retail along Central Avenue and Albemarle Road.',
    thingsToDo: 'The Eastland Yards redevelopment, community parks, and a quick drive to Plaza Midwood and Uptown.',
    nearby: ['plaza-midwood', 'stonehaven', 'uptown'],
  },
  {
    slug: 'stonehaven', name: 'Stonehaven', subtitle: 'Southeast Charlotte', group: 'South & East Charlotte',
    image: null,
    about: "An established southeast Charlotte neighborhood near Sardis and Rama Roads, known for its mid-century ranch homes, mature trees, and quiet, family-friendly streets. Convenient to Cotswold, Matthews, and Uptown.",
    food: 'Neighborhood restaurants nearby in Cotswold and along Monroe and Sardis Roads.',
    shops: 'Cotswold Village and everyday retail a short drive away.',
    thingsToDo: 'Neighborhood parks and greenway access, with Cotswold and Matthews close by.',
    nearby: ['cotswold', 'matthews', 'eastland'],
  },
  {
...
export const AREA_META: Record<string, AreaMeta> = {
  ...
  'camp-north-end': { zip: '28206', district: CMS[0], districtUrl: CMS[1] },
  'wesley-heights': { zip: '28208', district: CMS[0], districtUrl: CMS[1] },
  'enderly-park': { zip: '28208', district: CMS[0], districtUrl: CMS[1] },
  biddleville: { zip: '28216', district: CMS[0], districtUrl: CMS[1] },
  coulwood: { zip: '28214', district: CMS[0], districtUrl: CMS[1] },
  eastland: { zip: '28212', district: CMS[0], districtUrl: CMS[1] },
  stonehaven: { zip: '28270', district: CMS[0], districtUrl: CMS[1] },

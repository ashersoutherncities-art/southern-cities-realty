...
export const PHOTO_CREDITS: {name:string;creator:string;license:string;source:string}[] = [
  ...
  {"name": "Kannapolis", "creator": "Indy beetle", "license": "CC0", "source": "https://commons.wikimedia.org/wiki/File:Gem_Theater_in_Kannapolis.jpg"},
  ...
  {"name": "Steele Creek", "creator": "HowardMorland", "license": "Public domain", "source": "https://commons.wikimedia.org/wiki/File:Charlotte_Whitewater_01.jpg"},
